...
export type FontDetailCollectionFragment = { id: string, name: string, collectionType: string, isVariableFont: boolean, cssUrl: string | null, colors: Array<string> | null, isNew: boolean | null, sku: { id: string } | null, bundles: Array<{ sku: { id: string } | null }> | null, fontStyles: Array<{ name: string, cssFamily: string | null, cssWeight: string | null, cssStyle: string | null, sku: { id: string } | null, variableInstances: Array<{ name: string, coordinates: Array<{ axis: string, value: number }> }> | null }> };

export type FontDetailFragment = { shortDescription: string | null, description: string | null, designYear: string | null, languages: Array<string | null> | null, minisiteLink: string | null, id: string, name: string, collectionType: string, isVariableFont: boolean, cssUrl: string | null, colors: Array<string> | null, isNew: boolean | null, designers: Array<{ name: string }> | null, glyphGroups: Array<{ name: string }> | null, pdfs: Array<{ url: string | null, thumbnailUrl: string | null, name: string | null } | null> | null, featureStyle: { cssFamily: string | null, name: string, supportedLanguages: Array<string> | null, glyphNames: Array<{ name: string }> | null, webfontSources: Array<{ format: string | null } | null> | null, family: { cssUrl: string | null } | null } | null, children: Array<{ id: string, name: string, collectionType: string, isVariableFont: boolean, cssUrl: string | null, colors: Array<string> | null, isNew: boolean | null, sku: { id: string } | null, bundles: Array<{ sku: { id: string } | null }> | null, fontStyles: Array<{ name: string, cssFamily: string | null, cssWeight: string | null, cssStyle: string | null, sku: { id: string } | null, variableInstances: Array<{ name: string, coordinates: Array<{ axis: string, value: number }> }> | null }> }> | null, images: Array<{ url: string | null, description: string | null, meta: { mimeType: string | null, width: number | null, height: number | null } | null }> | null, sku: { id: string } | null, bundles: Array<{ sku: { id: string } | null }> | null, fontStyles: Array<{ name: string, cssFamily: string | null, cssWeight: string | null, cssStyle: string | null, sku: { id: string } | null, variableInstances: Array<{ name: string, coordinates: Array<{ axis: string, value: number }> }> | null }> };
...
export type FontQuery = { viewer: { slug: { fontCollection: { shortDescription: string | null, description: string | null, designYear: string | null, languages: Array<string | null> | null, minisiteLink: string | null, id: string, name: string, collectionType: string, isVariableFont: boolean, cssUrl: string | null, colors: Array<string> | null, isNew: boolean | null, pageMetadata: { title: string | null, description: string | null, keywords: string | null } | null, designers: Array<{ name: string }> | null, glyphGroups: Array<{ name: string }> | null, pdfs: Array<{ url: string | null, thumbnailUrl: string | null, name: string | null } | null> | null, featureStyle: { cssFamily: string | null, name: string, supportedLanguages: Array<string> | null, glyphNames: Array<{ name: string }> | null, webfontSources: Array<{ format: string | null } | null> | null, family: { cssUrl: string | null } | null } | null, children: Array<{ id: string, name: string, collectionType: string, isVariableFont: boolean, cssUrl: string | null, colors: Array<string> | null, isNew: boolean | null, sku: { id: string } | null, bundles: Array<{ sku: { id: string } | null }> | null, fontStyles: Array<{ name: string, cssFamily: string | null, cssWeight: string | null, cssStyle: string | null, sku: { id: string } | null, variableInstances: Array<{ name: string, coordinates: Array<{ axis: string, value: number }> }> | null }> }> | null, images: Array<{ url: string | null, description: string | null, meta: { mimeType: string | null, width: number | null, height: number | null } | null }> | null, sku: { id: string } | null, bundles: Array<{ sku: { id: string } | null }> | null, fontStyles: Array<{ name: string, cssFamily: string | null, cssWeight: string | null, cssStyle: string | null, sku: { id: string } | null, variableInstances: Array<{ name: string, coordinates: Array<{ axis: string, value: number }> }> | null }> } | null } | null } };
...
export type HomePageQuery = { viewer: { fontCollections: { edges: Array<{ node: { id: string, name: string, isNew: boolean | null, slug: { name: string | null } | null, fontStyles: Array<{ name: string }>, featureStyle: { cssFamily: string | null, name: string, webfontSources: Array<{ format: string | null, url: string | null } | null> | null, family: { colors: Array<string> | null } | null } | null } | null } | null> | null } | null } };
