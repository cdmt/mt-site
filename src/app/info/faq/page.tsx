...
export default function FAQ() {
    return(
        ...
        <dl className={info_styles.faq_page}>
            ...
            <dt><h3>What is an End User Licence Agreement?</h3></dt>
            ...
            <dt><h3>What languages do the fonts support?</h3></dt>
            <dd>The supported character sets are shown on the individual type pages.</dd>
            <dt><h3>Why are some fonts named “New”?</h3></dt>
            ...
            <dt><h3>Can the fonts be returned?</h3></dt>
            ...
            <dt><h3>Can I alter, add or change the fonts?</h3></dt>
            ...
            <dt><h3>Can I use the fonts in a website?</h3></dt>
            ...
            <dt><h3>Have another question ?</h3></dt>
